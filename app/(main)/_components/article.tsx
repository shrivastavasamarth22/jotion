...
export const Article = ({ document }: ArticleProps) => {
	...
	return (
		<div
			className={cn(
				"w-full flex justify-between bg-gray-50 dark:bg-muted rounded-lg px-5 shadow-md relative overflow-hidden",
				document.tags.length > 0 ? "py-4" : "h-36 py-4",
				isMobile && "mb-10"
			)}
			style={{
				backgroundImage: document.coverImage
